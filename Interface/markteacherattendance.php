...
<head>
	...
	$teacher = new Teacher(); // Checking for user logged in or not
	if ( $_SERVER[ 'REQUEST_METHOD' ] === 'POST' ) {
		if ( isset( $_REQUEST[ 'submit' ] ) ) {
			extract( $_REQUEST );
			
			$register = $teacher->mark_attendance($tid, $date,$status);
			if ($register) {
		...
		<form class="" action="" method="post" name="register">
			<div class="row">
				...
				<div class="input-group input-group-icon">
					<input type="text" placeholder="Teacher ID" id="nameID" name='tid'/>
